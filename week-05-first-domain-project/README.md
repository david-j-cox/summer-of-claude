...
with the system the whole way. This is your first real project. The skills are
breaking a goal into steps, building each step with the system, and checking the
result instead of assuming it is right.
...
You do not need to know how to write one yet. Ask the system, and have it explain:
